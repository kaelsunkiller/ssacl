...
def load_weights(model, weight_path, args):
    ...
    # if args.stage=='train':
    pretrained_weights = pretrained_weights['model'] if 'model' in pretrained_weights else pretrained_weights
...
def setup(args):
    ...
    if args.model_type == "ViT-B_16":
        ...
        # model = VisionTransformer(zero_head=False, num_classes=num_classes)
        if args.stage=='train':
    ...
    logger.info("Total Parameter: \t%2.1fM, Trainable Parameter: \t%2.1fM" % (num_params, trainable_params))
    return args, model
...
def count_parameters(model):
    ...
    return params/1000000, trainable_params/1000000
...
def main():
    ...
    parser.add_argument("--dataset_split_path", default='/path/to/datasplits/RSNA_Pneumonia/', type=str)
