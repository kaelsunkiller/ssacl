...
parser.add_argument('--model', default='ssacl', type=str)
parser.add_argument('--last', default='ssacl_ft_10p', type=str)
parser.add_argument('--gpu', default=0, type=int)
parser.add_argument('--path', default="finetuning_outputs/", type=str)
