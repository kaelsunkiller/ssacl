...
def main():
    ...
    # Required parameters
    parser.add_argument("--name", default='SS-ACL',
    ...
    parser.add_argument("--prefix", type=str, default='ssacl/')
    parser.add_argument("--last", type=str, default='ssacl')
    ...
    parser.add_argument("--dataset_path", default='/path/to/dataset/ChestXray8/', type=str)
    parser.add_argument("--dataset_split_path", default='/path/to/datasplits/NIH_ChestX-ray/', type=str)
