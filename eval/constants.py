...
MIMIC_DATA_DIR = Path("/path/to/mimic_cxr/") # need to be changed
MS_CXR_JSON = Path("data/MS_CXR_Local_Alignment_v1.0.0.json")
...
MIMIC_IMG_DIR = MIMIC_DATA_DIR / "resize/files/"
